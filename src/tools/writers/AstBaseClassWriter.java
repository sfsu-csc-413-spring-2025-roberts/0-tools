...
public class AstBaseClassWriter extends AutoGeneratedFileWriter {
    ...
    public void write() throws Exception {
        ...
        if (this.tokenTree.exists()) {
            this.tokenTree.delete();
        }
        ...
        try (FileWriter writer = new FileWriter(this.tokenTree)) {
            writer.write(this.formattedLine("package ast;", 0, 2));

            writer.write(this.formattedLine("import lexer.daos.Token;", 0, 2));

            writer.write(this.formattedLine(getAutoGeneratedComment(), 0, 1));

            writer.write(this.formattedLine("public interface TokenTree {", 0, 1));
